...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.5\textwidth]{sut-logo.png}};   % sculogo watermark
    \end{tikzpicture}
\vfill}}}
...
\def\Address{ No.111, Shenliao West Road
} 
%
\def\CityZip{Shenyang, Liaoning 110870\\
	P.R.China} 
%
% Set your SCU e-mail here
\def\Email{\textbf{\color{scured}E-mail}: something@sut.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{scured}Tel/Fax}: +86 24-25496072}
%
% Set your department or personal website here
\def\URL{\textbf{\color{scured}URL}: {https://lxy.sut.edu.cn/}}
%
...
\def\school{\small{
		...
		~No.111, Shenliao West Road $\cdot$
		~Shenyang, China P.R} } 
...
%
\signature{
	\vspace{-12mm}\includegraphics[scale=0.3]{signature.jpg}\\\vspace{-2mm}
	\name
}
%\signature{\name}  % [[Alternate]]
%%------------------------------------------------------------------------------%%
...
\begin{document}
	...
	\begin{letter}{
		...
		%
		\opening{Dear editors and referees,}
...
Pay attention, this template is a modified based on the other university in overleaf.
